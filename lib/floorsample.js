...
var urlName2 = 'THFL';
var sample = '.jpg';
// var n = fs.readFileSync("/Users/setha/Documents/AshimBot/bin/floor4.jpg");
var Slack = require('node-slack-upload');

var token = "xoxp-59373884711-59380181521-62069112821-7d68eb4230";
...
iBot.prototype._smartresponse = function (originalMessage) {
    ...
    http.get(roomurl, function(response) {
        if (originalMessage.username !== 'slackbot') {
            self.postMessageToUser('ashseth91', roomurl, {as_user: true})
    } 
        else {
            self.postMessageToUser('ashseth91', 'V', {as_user: true})
        }
    })
        } else { 
            self.postMessageToUser('ashseth91', "Sorry! I don't have a map for that room" , {as_user: true})
        }
};
